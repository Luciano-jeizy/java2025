...
public class Main{
    public static void main(String[] args){
        ...
        //Criar um objto da classe bolo
        Bolo boloMaria = new Bolo();
        Bolo boloManuel = new Bolo();

        //Definir os valores das variáveis
        boloMaria.sabor ="Chocolate";
        boloMaria.tamanho =21;
        boloMaria.cobertura= true;

           
        boloManuel.sabor ="Maracujá";
        boloManuel.tamanho =30;
        boloManuel.cobertura= false;


        boloManuel.exibirDetalhes();
